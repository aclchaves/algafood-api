...
public class RestauranteController {
	...
	public ResponseEntity< List<RestauranteModel>> listar() {
		...
		return ResponseEntity.ok()
				//para liberar de apenas um site cruzado
				//.header(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, "http://127.0.0.1:8000")
				//aceita referencia cruzada de qqer site
...
//		
//		MappingJacksonValue pedidosWapper = new MappingJacksonValue(restaurantesModel);
//		
//		pedidosWapper.setSerializationView(RestauranteView.Resumo.class);
//		
//		if("apenas-nome".equals(projecao)) {
//			pedidosWapper.setSerializationView(RestauranteView.ApenasNome.class);
//		}else if("completo".equals(projecao)) {
//			pedidosWapper.setSerializationView(null);
//		}		
//		
