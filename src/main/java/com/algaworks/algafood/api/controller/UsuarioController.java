...
public class UsuarioController {
	...
	public List<UsuarioModel> listar(){
		List<Usuario> todosGrupos = usuarioRepository.findAll();
		
		return usuarioModelAssembler.toCollectionModel(todosGrupos);
	}
	...
	public void alteraSenha(@PathVariable Long usuarioId, 
		...
		cadastroUsuario.alterarSenha(usuarioId, senha.getSenhaAtual(),
				senha.getNovaSenha());
