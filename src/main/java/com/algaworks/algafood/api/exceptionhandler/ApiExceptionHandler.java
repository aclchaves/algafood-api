...
//			detail = String.format("O corpo da requisição está inválido. Verifique erro de sintaxe. "
//					+ "A propriedade '%s' está sendo ignorado.", ex.getPropertyName());
//		}
//		
//		if(ex instanceof UnrecognizedPropertyException) {
//			detail = String.format("O corpo da requisição está inválido. Verifique erro de sintaxe. "
//					+ "A propriedade '%s' não existe.", ex.getPropertyName());
//		}		
//		
//		Problem problem = createProblemBuilder(status, problemType, detail)
//				.build();
